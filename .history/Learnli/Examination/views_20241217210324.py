...
def register(request): 
    ...
    exams = Exam.objects.filter(created_by__in=follows).exclude(registered_candidates=candidate_profile)
...
'''
    ...
    return render(request,'RegisterforExamForm.html' ,{'form':form, 'submitted':submitted})
...
def delete_candidate(request, candidate_id):
        candidate= RegisterforExam.objects.get(pk = candidate_id)
        candidate.delete()
